...
namespace UPRProfiler.Common
{
    public class UPROpen
    {
        ...
        */
        ...
        /***
         * this function for stop upr profiling in script
         * once the upr desktop received stop instruction, it will stop test in a few seconds not immediately.
         * example:
         *    UPROpen.StopUPRProfiling();
         * return bool if upr package is not connected, function will be abort and return false. if stop instruction is sent to upr desktop will return true         
         */
        public static bool StopUPRProfiling()
        {
            return sendCustomizedAction("stop");
        }
    }
}