...
#pragma warning disable
                    ...
                    }, CancellationToken.None, TaskCreationOptions.RunContinuationsAsynchronously, System.Threading.Tasks.TaskScheduler.Current);
...
#pragma warning disable
        ...
        /// <param name="skipInactiveChildObjects"> Whether any children of the provided objects be skipped if they are inactive.</param>
        ...
        public static void CombineMeshesInGameObject(GameObject forObject, bool skipInactiveChildObjects, Action<string, string> OnError, MeshCombineTarget combineTarget = MeshCombineTarget.SkinnedAndStatic)
        {
            ...
            Renderer[] allRenderers = UtilityServicesRuntime.GetChildRenderersForCombining(forObject, skipInactiveChildObjects);
